...
<script> 
 ...
 <script>
 document.getElementById("s1").value("操作系统");</script>
<body>
    <form action="EditBlog">
    标题：<input type="text" id="elm2" name="title" placeholder="标题" value="${Title}"><br>
    博文分类：${Date}<select id="s1" name="category">
...
<option value="其他">其他</option>
     ...
     <textarea maxlength="100000" name="content" id="elm1">${Content}</textarea>
